...
<form action="admin.php" method="post" id="frmEditPregunta" onsubmit="return verificaPregunta();">
  <table style="margin-top:5px;" border="0" align="center" id="tblFrmEditar">
  	<tr>
      <td align="left" valign="middle">Seleccione secci&oacute;n:</td>
      <td align="left" valign="middle">&nbsp;<select data-placeholder="Indique una secci&oacute;n..." id="seldesSeccion" class="chosen-select" style="width:200px;" name="idSeccionEP" onChange="javascript:enviarDatos($(this).val(),'cargarPreguntas','frmEditPregunta');">
          <option value=""></option>
          <?php
					conectar("on");
  ...
  <tr>
      <td align="left" valign="middle">Seleccione pregunta:</td>
      <td align="left" valign="middle">
      	&nbsp;<select id="seldesPregunta" data-placeholder="Indique una pregunta..." style="width:200px;" class="chosen-select" name="idpregunta" onChange=" javascript:enviarDatos($(this).val(),'buscarPregunta','frmEditPreguntaE');"></select>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td valign="middle"><input type="text" id="nr1" name="nr1" /></td>
     </tr>
     <tr>
    ...
    <input type="hidden" name="accion" value="ediPre" />
