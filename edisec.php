...
<form action="admin.php" method="post" id="frmEditSeccionE" onsubmit="return verificaSeccionEditar();">
  <table style="margin-top:5px;" border="0" align="center" id="tblFrmEditar">
  	<tr>
      <td align="left" valign="middle">Seleccione secci&oacute;n:</td>
      <td align="left" valign="middle">&nbsp;<select data-placeholder="Indique una secci&oacute;n..." id="seldesSeccion" class="chosen-select" style="width:200px;" name="idSeccionS" onChange="javascript:enviarDatos($(this).val(),'buscarSeccion','frmEditSeccionE');">
          <option value=""></option>
          <?php
					conectar("on");
  ...
  <tr>
    ...
    <tr>
      ...
      <td><input type="text" id="nombreSE" name="nombreSE" maxlength="50"  /></td>
    </tr>
    <tr>
      <td>Tiempo de aplicaci&oacute;n:</td>
      <td><input type="text" onKeyPress="return soloNumeros(event);" id="tiempoSE" name="tiempoSeccion" maxlength="2"  /></td>
    </tr>
    <tr>
    ...
    <input type="hidden" name="accion" value="ediSec" />
